...
function EmptyState({message}) {
    return (
        <div className="w-full flex items-center flex-wrap justify-center pt-20  gap-10">
            <div className="grid gap-4 w-full">
                <svg className="mx-auto" xmlns="http://www.w3.org/2000/svg" width="116" height="121"
                ...
                <div>
                    <h2 className="text-center text-black text-base font-semibold leading-relaxed pb-1 ">{message}</h2>
                    <p className="text-center text-black text-sm font-normal leading-snug pb-4">Try adding 
                         participant <br/>see children </p>
